...
// Ambil data tugas untuk Bahasa Indonesia
$tugas_result = $conn->query("SELECT * FROM tugas WHERE mapel = 'Bahasa Indonesia' ORDER BY id ASC");
...
$submitted_tugas_result = $conn->query("
    ...
    AND tugas.mapel = 'Bahasa Indonesia'
...
<body>
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      ...
      <!-- Konten Utama -->
      <div class="col-md-9">
        <h2 class="text-center">Tugas Bahasa Indonesia</h2>

...
// Ambil data tugas untuk Pemrograman Web
$tugas_result = $conn->query("SELECT * FROM tugas WHERE mapel = 'Pemrograman Web' ORDER BY id ASC");
...
$submitted_tugas_result = $conn->query("
    ...
    AND tugas.mapel = 'Pemrograman Web'
...
<body>
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      ...
      <!-- Konten Utama -->
      <div class="col-md-9">
        <h2 class="text-center">Tugas Pemrograman Web</h2>

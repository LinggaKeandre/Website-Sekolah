...
// Ambil data tugas untuk Penjaskes
$tugas_result = $conn->query("SELECT * FROM tugas WHERE mapel = 'Penjaskes' ORDER BY id ASC");
...
<body>
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      ...
      <!-- Konten Utama -->
      <div class="col-md-9">
        <h2 class="text-center">Tugas Penjaskes</h2>
